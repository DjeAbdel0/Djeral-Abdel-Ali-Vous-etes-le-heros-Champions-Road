const chapters = {
  contrat: {
    ...
    description: "Alors que tu es en plein cours à l'école, un représentant du Real Madrid entre dans la salle. Tous les regards se tournent vers lui. Il s'approche de toi et te tends une lettre qui contient un contrat professionnel avec le club.",
  ...
  mcdo: {
    ...
    description: "Malheureusement rien tu echoue lamentablement a lecole. Tu garde un regret eternel pour avoir refuser ce contrat",
    boutons: [],
  },
  match: {
    titre: "Premier match",
  ...
  confiance: {
    ...
    description: "Tu rentre a la 2eme mi-temps. Tu fais un bon match et tu commence a prendre tes aises. Tu es completement épuisé a la fin du match.",
  ...
  patience: {
    ...
    description: "Tu as choisi d'attendre patiemment que le coach décide de te faire entrer. Il te fait rentrer a la 82eme minute. Tu reussis a marquer le but gagnant 2 mins apres. Bravo ",
  ...
  victoire: {
    titre: "La Victoire",
    description: "Félicitations, ton équipe a remporté le match ! Tu as contribué à la victoire de l'équipe avec 1 but, et maintenant tu as plusieurs choix à faire. Que vas-tu faire ensuite ?",
  ...
  repos: {
    ...
    image: "./assets/img/stadium.png",
    description: "Après l'effort, le réconfort. Tu prends du temps pour te reposer et récupérer de l'intensité du match. Go dormir il y a un autre match demain.",
    boutons: [{
      titre: "Prochain match",
      destination: "matchSuiv",
    }, ],
  ...
  fete: {
    ...
    image: "./assets/img/stadium.png",
    description: "C'est l'heure de la fête ! Tu a célèbré la victoire toute la nuit. Go dormir il y a un autre match demain.",
    boutons: [{
      titre: "Prochain match",
      destination: "matchSuiv",
    }, ],
  ...
  matchSuiv: {
    ...
    description: "Un joueur vient de se blesser, le coach décide de te faire rentrer. Tu commence a t'échauffer",
    image: "./assets/img/bench.jpg",
    boutons: [{
      titre: "remplacement",
      destination: "contrat",
...
function goToChapter(chapitre) {
  ...
  if (chapitre === "victoire" && obj.boutons[i].titre === "entrainement") {
    nouveauBtn.addEventListener('click', () => {
      twist === 1;
    })
  } else if (chapitre === "victoire" && obj.boutons[i].titre === "repos") {
    nouveauBtn.addEventListener('click', () => {
      twist === 2;
    })
  } else if (chapitre === "victoire" && obj.boutons[i].titre === "fete") {
    nouveauBtn.addEventListener('click', () => {
      twist === 3;
    })
  }
  if (twist === 1 && chapitre === "matchSuiv" && obj.boutons[i].titre === "remplacement" ) {
    obj.boutons[i].destination == "fete";
